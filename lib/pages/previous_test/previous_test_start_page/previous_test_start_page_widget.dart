...
import 'previous_test_start_page_model.dart';
export 'previous_test_start_page_model.dart';

class PreviousTestStartPageWidget extends StatefulWidget {
  const PreviousTestStartPageWidget({
    Key? key,
    this.customTestJson,
  }) : super(key: key);
  ...
  @override
  _PreviousTestStartPageWidgetState createState() =>
      _PreviousTestStartPageWidgetState();
}

class _PreviousTestStartPageWidgetState
    extends State<PreviousTestStartPageWidget> {
  late PreviousTestStartPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PreviousTestStartPageModel());
  }
