...
import 'previous_test_page_model.dart';
export 'previous_test_page_model.dart';

class PreviousTestPageWidget extends StatefulWidget {
  const PreviousTestPageWidget({
    Key? key,
    String? testId,
    int? first,
    int? offset,
  ...
  @override
  _PreviousTestPageWidgetState createState() => _PreviousTestPageWidgetState();
}

class _PreviousTestPageWidgetState extends State<PreviousTestPageWidget> {
  late PreviousTestPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PreviousTestPageModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().flag) {
        ...
        _model.testAttemptId =
            await TestGroup.createTestAttemptForATestByAUserCall.call(
          testId: getJsonField(
        ...
        _model.questionsList = await TestGroup
            ...
            .call(
          testAttemptId: TestGroup.createTestAttemptForATestByAUserCall
              .testAttemptId(
        ...
        setState(() {
          ...
          FFAppState().secondsList = functions
              .getSecondsInEachPage(TestGroup
                  ...
                  .length)
              .toList();
          FFAppState().testAttemptId = functions
              .checkString(TestGroup.createTestAttemptForATestByAUserCall
                  .testAttemptId(
                    (_model.testAttemptId?.jsonBody ?? ''),
                  )
                  .toString());
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () async {
                        ...
                        _model.testAttemptId3 = await TestGroup
                        ...
                        _model.submitRes2 = await TestGroup
                          ...
                          testAttemptId:
                              TestGroup.createTestAttemptForATestByAUserCall
                                  .testAttemptId(
                                    (_model.testAttemptId3?.jsonBody ?? ''),
                                  )
                                  .toString(),
                          userAnswersJsonStr:
                        ...
                        builder: (context) {
                          return Padding(
                            ...
                            child: Container(
                              ...
                              child: BubbleTrackForPreviousTestWidget(),
                            ),
                          );
                        },
                      ).then((value) => setState(() {}));
