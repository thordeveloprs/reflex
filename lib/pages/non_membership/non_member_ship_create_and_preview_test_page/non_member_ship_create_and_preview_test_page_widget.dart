...
import 'non_member_ship_create_and_preview_test_page_model.dart';
export 'non_member_ship_create_and_preview_test_page_model.dart';

class NonMemberShipCreateAndPreviewTestPageWidget extends StatefulWidget {
  const NonMemberShipCreateAndPreviewTestPageWidget({Key? key})
      : super(key: key);

  @override
  _NonMemberShipCreateAndPreviewTestPageWidgetState createState() =>
      _NonMemberShipCreateAndPreviewTestPageWidgetState();
}

class _NonMemberShipCreateAndPreviewTestPageWidgetState
    extends State<NonMemberShipCreateAndPreviewTestPageWidget>
    with TickerProviderStateMixin {
  late NonMemberShipCreateAndPreviewTestPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(
        context, () => NonMemberShipCreateAndPreviewTestPageModel());
  }
